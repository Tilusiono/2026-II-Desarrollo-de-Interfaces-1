...
const sistema = (function () {
    const eventos = [
        ...
        new Atletismo({ id: 'E4', titulo: 'Maratón 10K Ciudad', fecha: new Date(Date.now() + 86400000 * 7).toISOString(), prueba: '10 km', hora: '07:00', ubicacion: 'Parque Metropolitano', capacidad: 500, registrados: 420, precio: 20.00, descripcion: 'Carrera para toda la familia', imagen: 'https://picsum.photos/seed/event4/800/500' }),
        ...
        new Futbol({ id: 'E11', titulo: 'Torneo de Fútbol 7', fecha: new Date(Date.now() + 86400000 * 12).toISOString(), tipoCancha: 'Sintética', hora: '16:00', ubicacion: 'Centro Deportivo', capacidad: 100, registrados: 60, precio: 15.00, descripcion: 'Competencia amistosa de fútbol 7', imagen: 'https://picsum.photos/seed/event11/800/500' }),
