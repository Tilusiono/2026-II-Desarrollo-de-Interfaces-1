...
console.log('🚀 ui-personal.js cargado correctamente');
            ...
            <div class="card product-card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2 d-flex gap-2">
                        <button class="btn btn-edit btn-sm w-50 btn-editar-producto" data-id="${p.id}">
                            <i class="fas fa-edit"></i> Editar
                        </button>
                        <button class="btn btn-delete btn-sm w-50 btn-eliminar-producto" data-id="${p.id}">
...
function renderizarSedes() {
        ...
        col.innerHTML = `
            <div class="card sede-card h-100">
                <div class="card-body">
                    ...
                    <div class="mt-2 d-flex gap-2">
                        <button class="btn btn-edit btn-sm w-50 btn-editar-sede" data-id="${s.id}">
                            <i class="fas fa-edit"></i> Editar
                        </button>
                        <button class="btn btn-delete btn-sm w-50 btn-eliminar-sede" data-id="${s.id}">
                            <i class="fas fa-trash"></i> Eliminar
                        </button>
                    </div>
                </div>
    ...
    document.querySelectorAll('.btn-editar-sede').forEach(b => {
        b.addEventListener('click', function() {
    ...
    document.querySelectorAll('.btn-eliminar-sede').forEach(b => {
        b.addEventListener('click', function() {
...
async function crearProducto() {
    ...
    try {
        ...
        if (result.success) {
            ...
            mostrarNotificacion('❌ ' + errors.join(', '), 'danger');
        }
    } catch (error) {
...
async function eliminarProducto(id) {
    try {
        ...
        if (result.success) {
            ...
            mostrarNotificacion('❌ ' + result.error, 'danger');
        }
    } catch (error) {
        mostrarNotificacion('❌ Error: ' + error.message, 'danger');
    }
...
document.getElementById('link-agregar-producto')?.addEventListener('click', (e) => {
    e.preventDefault();
    new bootstrap.Modal(document.getElementById('modal-producto')).show();
});

document.getElementById('link-agregar-sede')?.addEventListener('click', (e) => {
    e.preventDefault();
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ DOM cargado, iniciando ui-personal.js');
    cargarProductos();
    document.getElementById('seccion-sedes').style.display = 'none';
});