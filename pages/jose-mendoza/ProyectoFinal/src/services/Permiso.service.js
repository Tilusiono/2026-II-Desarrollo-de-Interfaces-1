...
export class PermisosService {
  ...
  async eliminar(identificador) {
    const permisoEliminadoModelo = await this.permisoRepository.eliminar(identificador);
    
    if (!permisoEliminadoModelo) {
      throw new AppError("Permiso no encontrado", 404);
    }
    
    return new PermisoResponseDto(permisoEliminadoModelo);
  }
}
