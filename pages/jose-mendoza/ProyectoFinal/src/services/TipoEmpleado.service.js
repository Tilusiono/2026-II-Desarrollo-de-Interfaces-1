...
export class TiposEmpleadoService {
    ...
    const tipoEmpleadoEliminadoModelo = await this.tipoEmpleadoRepository.eliminar(identificador);
    
    if (!tipoEmpleadoEliminadoModelo) {
      throw new AppError("Tipo de empleado no encontrado", 404);
    }
    
    return new TipoEmpleadoResponseDto(tipoEmpleadoEliminadoModelo);
  }
}
