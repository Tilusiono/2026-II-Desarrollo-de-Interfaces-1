...
export class EmpleadosService {
    ...
    const empleadoEliminadoModelo = await this.empleadoRepository.eliminar(identificador);
    
    if (!empleadoEliminadoModelo) {
      throw new AppError("Empleado no encontrado", 404);
    }
    
    return new EmpleadoResponseDto(empleadoEliminadoModelo);
    }
}
